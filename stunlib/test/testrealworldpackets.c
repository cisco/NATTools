...
START_TEST (integrity_turn_response)
{
...
Suite * realworldmsg_suite(void)
{
  Suite *s = suite_create("Realworld STUN-message test");

  TCase *tc_realworld = tcase_create("Integrity");
  tcase_add_test(tc_realworld, integrity_turn_response);
