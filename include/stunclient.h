/***************************************************************************
 *                   STUN CLIENT
 *            Code library to handle and react to stun bind req/Resp in the ice context
 *--------------------------------------------------------------------------
 ...
 * Switches      : None
 *
 * Import        : stun client binder is a usage of STUN and therefore includes the stun api.
 *                  
 * Compatibility: ICE-19, STUN-Bis-15
 *
