/***************************************************************************
 *                   S T U N M S G
 *            Code library for encoding / decoding of STUN messages
 *--------------------------------------------------------------------------
 *                  (C) Copyright Tandberg Telecom AS 2006
 *==========================================================================
 *
 * Author        : Jarl Ove Staures (JOS), Tandberg Telecom AS.
 *                 Pål-Erik Martinsen (PEM), Tandberg Telecom AS.
 *                 Paul Mackell (PTM), Tandberg Telecom AS
 *
 * Export        : library funcs for encode/decode STUN msessages
 * Compatibility:  RFC5389,  RFC57663
 *
 ******************************************************************************/
